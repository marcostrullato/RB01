			...
			if (this.readyState == 4)
			{
				if (this.status == 200)
				{
					if (errorState)
					{
						...
						$(document.getElementById("roomberryStatusButton")).attr('data-original-title', "Connected");
					}
				...
				case "text":
					switch(roombaParameters[i].name + "-" + roombaParameters[i].value)
					{
						case "charging_state-0":
							document.getElementById(roombaParameters[i].name).value = "Discharged";
						break;
						case "charging_state-1":
							document.getElementById(roombaParameters[i].name).value = "Full charge";
						break;
						case "charging_state-2":
							document.getElementById(roombaParameters[i].name).value = "Charging";
						break;
						case "charging_state-3":
							document.getElementById(roombaParameters[i].name).value = "Keeping charge";
						break;
						case "charging_state-4":
							document.getElementById(roombaParameters[i].name).value = "-";
						break;
						case "charging_state-5":
							document.getElementById(roombaParameters[i].name).value = "Charging error";
						break;
						default:
							document.getElementById(roombaParameters[i].name).value = "-";
						break;
	...
	function circleSector(ctx, centerX, centerY, startAngle, endAngle, counterclockwise, radius, valueIR)
	{
		if (valueIR != 0)
		{
			...
			{
				case 130: message = "Forward";break;
				case 131: message = "Right";break;
				case 132: message = "Spot";break;
				case 133: message = "Max";break;
				case 134: message = "Small";break;
				case 135: message = "Madium";break;
				case 136: message = "Clean";break;
				case 137: message = "Stop";break;
				case 138: message = "Power";break;
				case 139: message = "Left curve.";break;
				case 140: message = "Right curve.";break;
				case 141: message = "Stop";break;
				case 161: message = "Dock \u{2191}";break;
				case 162: message = "Virtual wall.";break;
	...
	{			
		if (errorCounter++ > ERROR_LIMIT)
		{
			...
			$(document.getElementById("roomberryStatusButton")).attr('data-original-title', "Disconnected");
	...
	{			
		...
		document.getElementById("editRoombaModalTitle").innerHTML = "<span class=\"glyphicon glyphicon-edit\"></span> Edit Song " + (Number(document.getElementById("songSelector").value)+1);
		var HTTPCode = "";
		...
		document.getElementById("saveNameModalInput").value = "Song " + (Number(document.getElementById("songSelector").value)+1);	
	...
	{			
		$("#editRoombaModal").modal();
		document.getElementById("editRoombaModalTitle").innerHTML = "<span class=\"glyphicon glyphicon-edit\"></span> Edit schedule";
		var HTTPCode = "";
